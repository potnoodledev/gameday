...
export default function UserGameListPage() {
  ...
  return (
    <Layout currentGameIdFromProp={null}>
      ...
      <div className="min-h-screen bg-slate-900 py-8 px-4 sm:px-6 lg:px-8 text-slate-100">
        <div className="max-w-7xl mx-auto">
          ...
          <div className="flex flex-col md:flex-row md:space-x-8 lg:space-x-12">
            <aside className="w-full md:w-1/3 lg:w-1/4 mb-8 md:mb-0 md:sticky md:top-24 h-full">
